...
namespace LiteDbExplorer
{
    ...
    public static class AssemblyExtensions
    {
        ...
        {
            var attributes = assembly.GetCustomAttributes(typeof(TAttibute)).ToArray();
            return attributes.Length > 0 ? attributes[0] as TAttibute : null;
        }
        ...
        {
            var attributes = assembly.GetCustomAttributes(attribute).ToArray();
            ...
            var propertyInfo = attributeType.GetProperty(property);
