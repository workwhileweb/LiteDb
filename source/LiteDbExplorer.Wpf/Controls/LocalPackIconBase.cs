...
{
    public abstract class LocalPackIconBase : Control
    {
    ...
    public abstract class LocalPackIconBase<TKind> : LocalPackIconBase
    {
        ...
        /// </param>
        protected LocalPackIconBase(Func<IDictionary<TKind, string>> dataIndexFactory)
        {
        ...
        public static readonly DependencyProperty KindProperty
            = DependencyProperty.Register(nameof(Kind),
                                          typeof(TKind),
                                          typeof(LocalPackIconBase<TKind>),
        ...
        {
            ((LocalPackIconBase<TKind>)dependencyObject).UpdateData();
        }
