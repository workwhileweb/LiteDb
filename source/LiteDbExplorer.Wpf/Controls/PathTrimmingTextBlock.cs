...
namespace LiteDbExplorer.Wpf.Controls
{
    ...
    /*********************
    Based on: https://github.com/Dirkster99/SuggestBoxLib/blob/master/source/SuggestBoxLib/PathTrimmingTextBlock.cs
    ...
    **********************/
    ...
    /// </summary>
    public sealed class PathTrimmingTextBlock : UserControl
    {
        #region fields
        ...
        /// <summary>
        /// Implements the backing store of the <see cref="ShowEllipses"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty ShowEllipsesProperty =
            DependencyProperty.Register(nameof(ShowEllipses), typeof(EllipsisPlacement),
                typeof(PathTrimmingTextBlock),
                new PropertyMetadata(EllipsisPlacement.Center, OnShowEllipsesChanged));

        public static readonly DependencyProperty TextBlockStyleProperty = DependencyProperty.Register(
            nameof(TextBlockStyle), typeof(Style), typeof(PathTrimmingTextBlock), new PropertyMetadata(default(Style)));
        ...
        public PathTrimmingTextBlock()
        {
            ...
            _textBlock.SetBinding(TextBlockStyleProperty, new Binding
            {
                Source = this,
                Path = new PropertyPath(nameof(TextBlockStyle))
            });
        ...
        {
            get => (EllipsisPlacement) GetValue(ShowEllipsesProperty);
        ...
        protected override Size MeasureOverride(Size constraint)
        {
            ...
            var meas = GetTrimmedPath(Path, constraint, this.ShowEllipses, this);
        ...
        {
            var dpiScale = VisualTreeHelper.GetDpi(visual: ctrl);
            var pixelsPerDip = dpiScale.PixelsPerDip;
            var typeFace = new Typeface(fontFamily: ctrl.FontFamily, style: ctrl.FontStyle, weight: ctrl.FontWeight,
                stretch: ctrl.FontStretch);

            var text = new FormattedText(
                textToFormat: str,
                culture: CultureInfo.CurrentCulture,
                flowDirection: ctrl.FlowDirection,
                typeface: typeFace,
                emSize: ctrl.FontSize,
                foreground: ctrl.Foreground,
                pixelsPerDip: pixelsPerDip);

            return new Size(width: text.Width, height: text.Height);
        }
        ...
        /// <param name="d"></param>
        /// <param name="e"></param>
        private static void OnShowEllipsesChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            var @this = (PathTrimmingTextBlock) d;
